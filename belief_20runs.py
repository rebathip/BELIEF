...
algo_name = "belief" # put "lime" for lime, "baylime" for baylime
                      # and "sliceblurfe" for slice and "belief" for belief
results_dir = "results/"
num_runs = 20
...
for model_name in model_names:
    ...
    for img_filename in img_filenames:
        ...
        for i in np.arange(0, num_runs, step=1):
            ...
            pos_feature_ranks, neg_feature_ranks, pos_dict, neg_dict = exp.get_belief_explanations(sigma=sel_sigma)
