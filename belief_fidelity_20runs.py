...
img_src_dir = "images_all/"
fidelity_res_dir = "fidelity_results/"
po = 'M'
        ...
        for dir in dirs:
            ...
            if os.path.exists(pkl_filename):
                ...
                for res_file in res_files:
                    ...
                    aopc_key = f"{dataset_name}_{model_name}_{xai_name}_{img_name}"
                    dataset_dict[aopc_key] = computed_scores
